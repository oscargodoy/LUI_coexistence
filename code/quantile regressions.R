...
png(file="figures/quantile.reg.niche.3.png",width=700, height=500)
par(bg = 'grey92')
...
png(file="figures/quantile.reg.fitness.3.png",width=700, height=500)
par(bg = 'grey92')
