...
```{r restructure_plants_quanti, cache = TRUE}
...
```{r restructure_plants_qualit, cache = TRUE}
...
```{r lui_richness_full_comm, cache = TRUE}
#this chunk depends on chunk(s): restructure_lui
...
```{r lui_richness_26spp_comm, cache = TRUE}
...
```{r plot_lui_richness, cache = TRUE, warning = FALSE, message = FALSE, fig.height = 7, fig.width = 7}
...
```{r saturation, cache = TRUE, fig.height = 4, fig.width = 6}
#this chunk depends on chunk(s): restructure_plants_quanti
...
```{r function_selector, cache = TRUE}
